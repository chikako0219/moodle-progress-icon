M.block_progress_icon = {
    ...
    init: function (YUIObject, instances, users) {
        ...
        this.addEvent(window, 'resize', function(e) {M.block_progress_icon.setupScrolling(YUIObject);});
    },
    ...
    setupScrolling: function(YUIObject) {
        ...
        for (i = 0; i < barContainers.length; i++) {
            ...
            if(leftArrows.length > 0) {
                ...
                this.addEvent(leftArrows[0].firstChild, 'click', function(e) {M.block_progress_icon.scrollContainer(e.target.parentNode, -1); e.target.stopPagination();})
                this.addEvent(rightArrows[0].firstChild, 'click', function(e) {M.block_progress_icon.scrollContainer(e.target.parentNode, 1); e.target.stopPagination();})
            }
        }
    },
    ...
    scrollContainer: function(arrow, direction) {
        ...
        M.block_progress_icon.checkArrows(container);
    },
